...
# Funzione per estrarre i primi n esempi da usare come testo di inizializzazione
...
def main():
    ...
    # Inizializzazione token speciali se mancanti
    ...
    # Preprocessing: 2 turni fissi 
    def preprocess(example):
        msgs = example.get("messages", [])
        # assumiamo formato pulito 2 turni
    ...
    # Salvataggio del prompt adapter

...
def parse_args():
    ...
    p.add_argument("--num_virtual_tokens", type=int, default=20, help="Numero di token virtuali del prompt.")
...
def main():
    ...
    prompt_cfg = PromptTuningConfig(
        ...
        prompt_tuning_init_text=args.prompt_init_text if args.prompt_init_method == "TEXT" else None,

...
learning_rate = 5e-3
output_dir = "./codegpt_prompt_tuning"
...
prompt_tuning_config = PromptTuningConfig(
    ...
    prompt_tuning_init_text="def secure_function(user_input):\n    \"\"\"", # Inizializzazione con testo relativo alla sicurezza
)
...
print(f"💾 Spazio disco occupato dal Prompt Tuning adapter: {model_size:.2f} MB")

# 11. Log JSON
log_info = {
    "technique": "prompt_tuning",
